...
import { createMsaaSceneGeometry } from "@/lessons/lesson-74-msaa-and-alpha-to-coverage/geometry";
import {
  ...
  normalizeVector,
  type Vector3,
} from "@/lessons/lesson-74-msaa-and-alpha-to-coverage/math";
import presentFragmentShaderSource from "@/lessons/lesson-74-msaa-and-alpha-to-coverage/present.frag.wgsl?raw";
import presentVertexShaderSource from "@/lessons/lesson-74-msaa-and-alpha-to-coverage/present.vert.wgsl?raw";
import sceneFragmentShaderSource from "@/lessons/lesson-74-msaa-and-alpha-to-coverage/scene.frag.wgsl?raw";
import sceneVertexShaderSource from "@/lessons/lesson-74-msaa-and-alpha-to-coverage/scene.vert.wgsl?raw";
