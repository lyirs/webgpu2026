...
} from "@/lessons/lesson-34-gltf-skinning-basic/gltf";
import {
  composeNodeMatrix,
  ...
  type Quaternion,
  type Vector3,
} from "@/lessons/lesson-34-gltf-skinning-basic/math";
import fragmentShaderSource from "@/lessons/lesson-34-gltf-skinning-basic/model.frag.wgsl?raw";
import vertexShaderSource from "@/lessons/lesson-34-gltf-skinning-basic/model.vert.wgsl?raw";
...
export async function mountGltfSkinningBasicLesson(
  ...
  try {
    ...
    const pipeline = gpu.device.createRenderPipeline({
      label: "lesson-34-gltf-skinning-basic",
      layout: "auto",
      vertex: {
