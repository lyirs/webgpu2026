import computeShaderSource from "@/lessons/lesson-55-compute-foundations/compute.wgsl?raw";
import {
  createComputeFoundationsSeedData,
  type ComputeFoundationsSeed,
} from "@/lessons/lesson-55-compute-foundations/seed";
...
export async function mountComputeFoundationsLesson(
  ...
  try {
    ...
    const computePipeline = device.createComputePipeline({
      label: "lesson-55-compute-foundations",
      layout: "auto",
      compute: {
