...
import fragmentShaderSource from "@/lessons/lesson-32-gltf-pbr-basic/model.frag.wgsl?raw";
import vertexShaderSource from "@/lessons/lesson-32-gltf-pbr-basic/model.vert.wgsl?raw";
...
export async function mountGltfPbrBasicLesson(
  ...
  try {
    ...
    const pipeline = gpu.device.createRenderPipeline({
      label: "lesson-32-gltf-pbr-basic",
      layout: "auto",
      vertex: {
