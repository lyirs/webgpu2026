...
import accumulateComputeShaderSource from "@/lessons/lesson-89-restir-di-temporal-stabilization-and-entry-denoising/accumulate.compute.wgsl?raw";
import presentShaderSource from "@/lessons/lesson-89-restir-di-temporal-stabilization-and-entry-denoising/present.wgsl?raw";
import spatialComputeShaderSource from "@/lessons/lesson-89-restir-di-temporal-stabilization-and-entry-denoising/spatial.compute.wgsl?raw";
import temporalComputeShaderSource from "@/lessons/lesson-89-restir-di-temporal-stabilization-and-entry-denoising/temporal.compute.wgsl?raw";
import {
  CANDIDATES,
  GRID_HEIGHT,
  GRID_WIDTH,
