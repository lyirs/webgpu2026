...
import { createHiDpiSizingLessonGeometry } from "@/lessons/lesson-44-hidpi-canvas-sizing/geometry";
import {
  ...
  multiplyMatrices,
  type Vector3,
} from "@/lessons/lesson-44-hidpi-canvas-sizing/math";
import presentShaderSource from "@/lessons/lesson-44-hidpi-canvas-sizing/present.wgsl?raw";
import fragmentShaderSource from "@/lessons/lesson-44-hidpi-canvas-sizing/scene.frag.wgsl?raw";
import vertexShaderSource from "@/lessons/lesson-44-hidpi-canvas-sizing/scene.vert.wgsl?raw";
