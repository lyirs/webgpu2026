...
import fragmentShaderSource from "@/lessons/lesson-43-camera-controls/cube.frag.wgsl?raw";
import { createCameraCubeGeometry } from "@/lessons/lesson-43-camera-controls/cube-data";
import {
  ...
  multiplyMatrices,
  type Vector3,
} from "@/lessons/lesson-43-camera-controls/math";
import vertexShaderSource from "@/lessons/lesson-43-camera-controls/cube.vert.wgsl?raw";
...
export async function mountCameraControlsLesson(
  ...
  try {
    ...
    const pipeline = gpu.device.createRenderPipeline({
      label: "lesson-43-camera-controls",
      layout: "auto",
      vertex: {
