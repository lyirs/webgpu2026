...
import {
  ...
  normalizeVector,
  type Vector3,
} from "@/lessons/lesson-29-gltf-scene-integration/math";
import fragmentShaderSource from "@/lessons/lesson-29-gltf-scene-integration/model.frag.wgsl?raw";
import vertexShaderSource from "@/lessons/lesson-29-gltf-scene-integration/model.vert.wgsl?raw";
...
export async function mountGltfSceneIntegrationLesson(
  ...
  try {
    ...
    const pipeline = gpu.device.createRenderPipeline({
      label: "lesson-29-gltf-scene-integration",
      layout: "auto",
      vertex: {
