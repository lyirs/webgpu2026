...
import computeShaderSource from "@/lessons/lesson-37-compute-bitonic-sort/bitonic-sort.compute.wgsl?raw";
import fragmentShaderSource from "@/lessons/lesson-37-compute-bitonic-sort/bitonic-sort.frag.wgsl?raw";
import {
  createBitonicSortSeedData,
  type SortSeed,
} from "@/lessons/lesson-37-compute-bitonic-sort/sort-data";
import vertexShaderSource from "@/lessons/lesson-37-compute-bitonic-sort/bitonic-sort.vert.wgsl?raw";
