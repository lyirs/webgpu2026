...
import { createPickingSceneGeometry } from "@/lessons/lesson-30-primitive-picking/geometry";
import {
  ...
  normalizeVector,
  type Vector3,
} from "@/lessons/lesson-30-primitive-picking/math";
import pickingFragmentShaderSource from "@/lessons/lesson-30-primitive-picking/picking.frag.wgsl?raw";
import pickingVertexShaderSource from "@/lessons/lesson-30-primitive-picking/picking.vert.wgsl?raw";
import sceneFragmentShaderSource from "@/lessons/lesson-30-primitive-picking/scene.frag.wgsl?raw";
import sceneVertexShaderSource from "@/lessons/lesson-30-primitive-picking/scene.vert.wgsl?raw";
...
export async function mountPrimitivePickingLesson(
  ...
  try {
    ...
    const pickObject = async (event: MouseEvent) => {
      if (!pickingTarget.texture || pickInFlight) {
        return;
      }
