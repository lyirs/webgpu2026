...
import fragmentShaderSource from "@/lessons/lesson-11-free-orbit-camera/cube.frag.wgsl?raw";
import { createFreeOrbitCubeGeometry } from "@/lessons/lesson-11-free-orbit-camera/cube-data";
import {
  addVectors,
  ...
  scaleVector,
  type Vector3,
} from "@/lessons/lesson-11-free-orbit-camera/math";
import vertexShaderSource from "@/lessons/lesson-11-free-orbit-camera/cube.vert.wgsl?raw";
...
export async function mountFreeOrbitCameraLesson(
  ...
  try {
    ...
    const pipeline = gpu.device.createRenderPipeline({
      label: "lesson-11-free-orbit-camera",
      layout: "auto",
      vertex: {
