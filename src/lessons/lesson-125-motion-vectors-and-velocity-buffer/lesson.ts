...
import presentShaderSource from "@/lessons/lesson-125-motion-vectors-and-velocity-buffer/present.wgsl?raw";
import sceneFragmentShaderSource from "@/lessons/lesson-125-motion-vectors-and-velocity-buffer/scene.frag.wgsl?raw";
import sceneVertexShaderSource from "@/lessons/lesson-125-motion-vectors-and-velocity-buffer/scene.vert.wgsl?raw";
