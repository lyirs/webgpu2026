...
import pathTraceShaderSource from "@/lessons/lesson-138-compute-path-tracing-foundations/path-trace.wgsl?raw";
import presentShaderSource from "@/lessons/lesson-138-compute-path-tracing-foundations/present.wgsl?raw";
import sceneFragmentShaderSource from "@/lessons/lesson-138-compute-path-tracing-foundations/scene.frag.wgsl?raw";
import sceneVertexShaderSource from "@/lessons/lesson-138-compute-path-tracing-foundations/scene.vert.wgsl?raw";
