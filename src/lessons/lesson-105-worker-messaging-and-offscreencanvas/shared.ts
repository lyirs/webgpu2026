import {
  ...
  multiplyMatrices,
  type Vector3,
} from "@/lessons/lesson-105-worker-messaging-and-offscreencanvas/math";
...
export const WORKER_HEARTBEAT_INTERVAL_MS = 320;
 ...
 */
export function createWorkerMessagingSceneConfigs(): SceneObjectConfig[] {
