...
import { createPostProcessCubeGeometry } from "@/lessons/lesson-66-post-processing/cube-data";
import {
  ...
  normalizeVector,
  type Vector3,
} from "@/lessons/lesson-66-post-processing/math";
import postFragmentShaderSource from "@/lessons/lesson-66-post-processing/post.frag.wgsl?raw";
import postVertexShaderSource from "@/lessons/lesson-66-post-processing/post.vert.wgsl?raw";
import sceneFragmentShaderSource from "@/lessons/lesson-66-post-processing/scene.frag.wgsl?raw";
import sceneVertexShaderSource from "@/lessons/lesson-66-post-processing/scene.vert.wgsl?raw";
