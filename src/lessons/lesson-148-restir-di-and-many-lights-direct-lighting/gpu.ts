...
import presentShaderSource from "@/lessons/lesson-148-restir-di-and-many-lights-direct-lighting/present.wgsl?raw";
import spatialComputeShaderSource from "@/lessons/lesson-148-restir-di-and-many-lights-direct-lighting/spatial.compute.wgsl?raw";
import temporalComputeShaderSource from "@/lessons/lesson-148-restir-di-and-many-lights-direct-lighting/temporal.compute.wgsl?raw";
import {
  GRID_HEIGHT,
  GRID_WIDTH,
  LIGHT_STRIDE,
  ...
  type RestirGpuState,
  type RestirSettings,
} from "@/lessons/lesson-148-restir-di-and-many-lights-direct-lighting/types";
