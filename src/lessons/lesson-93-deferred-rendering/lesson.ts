...
import { createDeferredSceneGeometry } from "@/lessons/lesson-93-deferred-rendering/geometry";
import {
  ...
  multiplyMatrices,
  type Vector3,
} from "@/lessons/lesson-93-deferred-rendering/math";
import gbufferFragmentShaderSource from "@/lessons/lesson-93-deferred-rendering/gbuffer.frag.wgsl?raw";
import gbufferVertexShaderSource from "@/lessons/lesson-93-deferred-rendering/gbuffer.vert.wgsl?raw";
import lightingFragmentShaderSource from "@/lessons/lesson-93-deferred-rendering/lighting.frag.wgsl?raw";
import lightingVertexShaderSource from "@/lessons/lesson-93-deferred-rendering/lighting.vert.wgsl?raw";
