...
import fragmentShaderSource from "@/lessons/lesson-51-scene-graph/cube.frag.wgsl?raw";
import { createSceneGraphCubeGeometry } from "@/lessons/lesson-51-scene-graph/cube-data";
import {
  ...
  normalizeVector,
  type Vector3,
} from "@/lessons/lesson-51-scene-graph/math";
import vertexShaderSource from "@/lessons/lesson-51-scene-graph/cube.vert.wgsl?raw";
