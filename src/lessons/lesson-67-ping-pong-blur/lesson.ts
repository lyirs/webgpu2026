...
import { createPingPongCubeGeometry } from "@/lessons/lesson-67-ping-pong-blur/cube-data";
import {
  ...
  normalizeVector,
  type Vector3,
} from "@/lessons/lesson-67-ping-pong-blur/math";
import blurFragmentShaderSource from "@/lessons/lesson-67-ping-pong-blur/blur.frag.wgsl?raw";
import fullscreenVertexShaderSource from "@/lessons/lesson-67-ping-pong-blur/fullscreen.vert.wgsl?raw";
import presentFragmentShaderSource from "@/lessons/lesson-67-ping-pong-blur/present.frag.wgsl?raw";
import sceneFragmentShaderSource from "@/lessons/lesson-67-ping-pong-blur/scene.frag.wgsl?raw";
import sceneVertexShaderSource from "@/lessons/lesson-67-ping-pong-blur/scene.vert.wgsl?raw";
