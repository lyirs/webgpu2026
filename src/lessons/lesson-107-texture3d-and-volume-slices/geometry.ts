...
export type Texture3dSliceLessonGeometry = {
  cube: GeometryMesh;
  plane: GeometryMesh;
};

/**
 * 创建第 45 课会复用的盒体和切片平面几何。
 * @returns {Texture3dSliceLessonGeometry} 包含单位立方体和单位平面的网格数据。
 */
export function createTexture3dSliceLessonGeometry(): Texture3dSliceLessonGeometry {
