...
} from "@/lessons/lesson-31-gltf-animation-basic/gltf";
import {
  composeNodeMatrix,
  ...
  type Quaternion,
  type Vector3,
} from "@/lessons/lesson-31-gltf-animation-basic/math";
import fragmentShaderSource from "@/lessons/lesson-31-gltf-animation-basic/model.frag.wgsl?raw";
import vertexShaderSource from "@/lessons/lesson-31-gltf-animation-basic/model.vert.wgsl?raw";
...
export async function mountGltfAnimationBasicLesson(
  ...
  try {
    ...
    const pipeline = gpu.device.createRenderPipeline({
      label: "lesson-31-gltf-animation-basic",
      layout: "auto",
      vertex: {
