...
import computeShaderSource from "@/lessons/lesson-65-compute-particles/particles.compute.wgsl?raw";
import fragmentShaderSource from "@/lessons/lesson-65-compute-particles/particles.frag.wgsl?raw";
import {
  createParticleSeedData,
  type ParticleSeed,
} from "@/lessons/lesson-65-compute-particles/particle-data";
import vertexShaderSource from "@/lessons/lesson-65-compute-particles/particles.vert.wgsl?raw";
...
export async function mountComputeParticlesLesson(
  ...
  try {
    ...
    const computePipeline = gpu.device.createComputePipeline({
      label: "lesson-65-compute-particles",
      layout: "auto",
      compute: {
