import computeShaderSource from "@/lessons/lesson-119-prefix-sum-and-stream-compaction/compute.wgsl?raw";
import {
  createPrefixSumSeedData,
  type PrefixSumSeed,
} from "@/lessons/lesson-119-prefix-sum-and-stream-compaction/seed";
