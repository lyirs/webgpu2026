...
import fragmentShaderSource from "@/lessons/lesson-45-specular-materials/cube.frag.wgsl?raw";
import { createSpecularCubeGeometry } from "@/lessons/lesson-45-specular-materials/cube-data";
import {
  addVectors,
  ...
  scaleVector,
  type Vector3,
} from "@/lessons/lesson-45-specular-materials/math";
import vertexShaderSource from "@/lessons/lesson-45-specular-materials/cube.vert.wgsl?raw";
...
export async function mountSpecularMaterialsLesson(
  ...
  try {
    ...
    const pipeline = gpu.device.createRenderPipeline({
      label: "lesson-45-specular-materials",
      layout: "auto",
      vertex: {
