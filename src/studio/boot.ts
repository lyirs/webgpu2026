...
function emphasizedLineClass(line: string, language: string): string {
  ...
  const importantPatterns =
    language === "wgsl"
      ? [
          /@(vertex|fragment|group|binding|location|builtin)\b/,
          /var<uniform>/,
          /textureSample\(/,
          /textureSampleLevel\(/,
          /output\.clipPosition/,
...
function getLessonById(id: string | null): LessonDefinition {
  const defaultLesson = lessons.find((lesson) => lesson.id === "01-hello-triangle");
